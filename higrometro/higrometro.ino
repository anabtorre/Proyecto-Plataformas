...
const int relayBombaHg = 2; // Bomba que se activa cuando la humedad esta baja. En el pin 2 del relay
...
void loop()
{
  // Cuando el hongo tiene suficiente humedad en la tieera, el sensor va a leer entre 380-400
